      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full h-12 px-4 rounded-lg border-2 focus:ring focus:ring-opacity-50 placeholder-gray-400 shadow-sm ${
                      theme === 'dark'
          ...
          <div className={`${
            ...
            theme === 'dark' ? 'border-slate-700' : 'border-purple-100'
          }`}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-3 gap-12 relative">
              <div className={`backdrop-blur-sm rounded-xl p-8 shadow-xl text-center group hover:scale-105 transition-all duration-300 relative ${
                theme === 'dark'
